        ...
        >
            ...
            <div className={sysStyles.card_box}>
                <div className={sysStyles.text_field} style={{marginTop:"2rem"}}>
                    ...
                    <TextField id='menuName' label="메뉴 관리" variant='outlined' sx={{width:"20rem"}}/>
                </div>
                <div className={sysStyles.text_field}>
                    <div className={sysStyles.text}>{"상위 폴더"}</div>
                    <TextField id='upperFolder' label="시스템 관리" variant='outlined' sx={{width:"20rem"}}/>
                </div>
                <div className={sysStyles.text_field}>
...
export function CmDeleteModal({isModalOpen, handleOk, handleCancel}){
